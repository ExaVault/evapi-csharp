...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FormResponse :  IEquatable<FormResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public FormResponse(int? responseStatus = default(int?), Form data = default(Form), List<Included> included = default(List<Included>))
        {
        ...
        {
            return this.Equals(input as FormResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(FormResponse input)
        {
            if (input == null)
                return false;
