...
namespace IO.Swagger.Model
{
        ...
        public partial class Notification :  IEquatable<Notification>, IValidatableObject
    {
        ...
        public Notification(int? id = default(int?), string type = default(string), NotificationAttributes attributes = default(NotificationAttributes), NotificationRelationships relationships = default(NotificationRelationships))
        {
            this.Id = id;
            this.Type = type;
