...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FormEntryResponse :  IEquatable<FormEntryResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormEntryResponse" /> class.
        /// </summary>
        ...
        public FormEntryResponse(int? responseStatus = default(int?), int? totalResults = default(int?), int? returnedResults = default(int?), List<FormEntry> data = default(List<FormEntry>))
        {
        ...
        public List<FormEntry> Data { get; set; }
        ...
        {
            return this.Equals(input as FormEntryResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(FormEntryResponse input)
        {
            if (input == null)
                return false;
