...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AccountAllowedIpRanges :  IEquatable<AccountAllowedIpRanges>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="AccountAllowedIpRanges" /> class.
        /// </summary>
        /// <param name="ipStart">ipStart.</param>
        /// <param name="ipEnd">ipEnd.</param>
        public AccountAllowedIpRanges(string ipStart = default(string), string ipEnd = default(string))
        {
        ...
        {
            return this.Equals(input as AccountAllowedIpRanges);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(AccountAllowedIpRanges input)
        {
            if (input == null)
                return false;
