...
namespace IO.Swagger.Model
{
        ...
        public partial class Body16 :  IEquatable<Body16>, IValidatableObject
    {
        ...
        public Body16(TypeEnum type = default(TypeEnum), string name = default(string), List<string> resources = default(List<string>), List<string> accessMode = default(List<string>), bool? embed = default(bool?), List<SharesRecipients> recipients = default(List<SharesRecipients>), DateTime? expiration = default(DateTime?), bool? hasNotification = default(bool?), bool? isPublic = default(bool?), string message = default(string), List<string> notificationEmails = default(List<string>), string password = default(string), bool? requireEmail = default(bool?), string subject = default(string), bool? fileDropCreateFolders = default(bool?), bool? sendingLocalFiles = default(bool?))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for Body16 and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for Body16 and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (accessMode == null)
            {
                throw new InvalidDataException("accessMode is a required property for Body16 and cannot be null");
            }
            else
            {
