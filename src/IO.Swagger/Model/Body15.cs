...
namespace IO.Swagger.Model
{
        ...
        public partial class Body15 :  IEquatable<Body15>, IValidatableObject
    {
        ...
        public Body15(List<string> emails = default(List<string>), string message = default(string))
        {
            // to ensure "emails" is required (not null)
            if (emails == null)
            {
                throw new InvalidDataException("emails is a required property for Body15 and cannot be null");
            }
            else
            {
                this.Emails = emails;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for Body15 and cannot be null");
            }
            else
            {
