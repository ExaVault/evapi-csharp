...
namespace IO.Swagger.Model
{
        ...
        public partial class Body12 :  IEquatable<Body12>, IValidatableObject
    {
        ...
        public Body12(List<string> resources = default(List<string>), string parentResource = default(string))
        {
            // to ensure "resources" is required (not null)
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for Body12 and cannot be null");
            }
            else
            {
            ...
            {
                throw new InvalidDataException("parentResource is a required property for Body12 and cannot be null");
            }
            else
            {
