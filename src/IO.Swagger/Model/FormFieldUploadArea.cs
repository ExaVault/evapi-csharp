...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class FormFieldUploadArea :  IEquatable<FormFieldUploadArea>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="FormFieldUploadArea" /> class.
        /// </summary>
        ...
        public FormFieldUploadArea(int? id = default(int?), string name = default(string), int? order = default(int?), string type = default(string), FormFieldUploadAreaSettings settings = default(FormFieldUploadAreaSettings))
        {
            this.Id = id;
            this.Name = name;
            this.Order = order;
        ...
        public FormFieldUploadAreaSettings Settings { get; set; }
        ...
        {
            return this.Equals(input as FormFieldUploadArea);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(FormFieldUploadArea input)
        {
            if (input == null)
                return false;
