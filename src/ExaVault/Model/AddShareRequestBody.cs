...
namespace ExaVault.Model
{
        ...
        public partial class AddShareRequestBody :  IEquatable<AddShareRequestBody>, IValidatableObject
    {
        ...
        /// <param name="messageBody">The message to be included in email invitations for your recipients. Ignored if you have not also provided &#x60;recipients&#x60; and &#x60;messageSubject&#x60;.</param>
        ...
        /// <param name="messageSubject">Subject to use on emails inviting recipients to the share. Ignored if you have not also provided &#x60;recipients&#x60; and a &#x60;messageBody&#x60;.</param>
        ...
        public AddShareRequestBody(TypeEnum type = default(TypeEnum), string name = default(string), List<string> resources = default(List<string>), AccessMode accessMode = default(AccessMode), bool? embed = default(bool?), List<SharesRecipients> recipients = default(List<SharesRecipients>), DateTime? expiration = default(DateTime?), bool? hasNotification = default(bool?), bool? isPublic = default(bool?), string messageBody = default(string), List<string> notificationEmails = default(List<string>), string password = default(string), bool? requireEmail = default(bool?), string messageSubject = default(string), bool? fileDropCreateFolders = default(bool?), bool? sendingLocalFiles = default(bool?))
        {
        ...
        /// </summary>
        /// <value>The message to be included in email invitations for your recipients. Ignored if you have not also provided &#x60;recipients&#x60; and &#x60;messageSubject&#x60;</value>
        ...
        /// </summary>
        /// <value>Subject to use on emails inviting recipients to the share. Ignored if you have not also provided &#x60;recipients&#x60; and a &#x60;messageBody&#x60;</value>
