...
namespace ExaVault.Model
{
        ...
        public partial class UpdateShareRequestBody :  IEquatable<UpdateShareRequestBody>, IValidatableObject
    {
        ...
        public UpdateShareRequestBody(string name = default(string), List<string> resources = default(List<string>), AccessMode accessMode = default(AccessMode), bool? embed = default(bool?), List<SharesRecipients> recipients = default(List<SharesRecipients>), DateTime? expiration = default(DateTime?), bool? hasNotification = default(bool?), bool? isPublic = default(bool?), string messageBody = default(string), List<string> notificationEmails = default(List<string>), string password = default(string), bool? requireEmail = default(bool?), string messageSubject = default(string), bool? fileDropCreateFolders = default(bool?), int? status = default(int?))
        {
            this.Name = name;
