...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AddNotificationRequestBody :  IEquatable<AddNotificationRequestBody>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AddNotificationRequestBody" /> class.
        /// </summary>
        ...
        public AddNotificationRequestBody(TypeEnum type = default(TypeEnum), string resource = default(string), ActionEnum action = default(ActionEnum), List<string> usernames = default(List<string>), bool? sendEmail = default(bool?), List<string> recipients = default(List<string>), string message = default(string))
        {
            // to ensure "type" is required (not null)
            if (type == null)
            {
                throw new InvalidDataException("type is a required property for AddNotificationRequestBody and cannot be null");
            }
            else
            {
                this.Type = type;
            ...
            if (resource == null)
            {
                throw new InvalidDataException("resource is a required property for AddNotificationRequestBody and cannot be null");
            }
            else
            {
            ...
            if (action == null)
            {
                throw new InvalidDataException("action is a required property for AddNotificationRequestBody and cannot be null");
            }
            else
            {
                this.Action = action;
            ...
            if (usernames == null)
            {
                throw new InvalidDataException("usernames is a required property for AddNotificationRequestBody and cannot be null");
            }
            else
            {
            ...
            if (sendEmail == null)
            {
                throw new InvalidDataException("sendEmail is a required property for AddNotificationRequestBody and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AddNotificationRequestBody);
        }

        /// <summary>
        /// Returns true if AddNotificationRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of AddNotificationRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AddNotificationRequestBody input)
        {
            if (input == null)
                return false;
