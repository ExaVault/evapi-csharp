...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CallbackSettingsValuesTriggers :  IEquatable<CallbackSettingsValuesTriggers>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CallbackSettingsValuesTriggers" /> class.
        /// </summary>
        ...
        public CallbackSettingsValuesTriggers(bool? download = default(bool?), bool? upload = default(bool?), bool? delete = default(bool?), bool? createFolder = default(bool?), bool? rename = default(bool?), bool? move = default(bool?), bool? copy = default(bool?), bool? compress = default(bool?), bool? extract = default(bool?), bool? shareFolder = default(bool?), bool? sendFiles = default(bool?), bool? receiveFiles = default(bool?), bool? updateShare = default(bool?), bool? updateReceive = default(bool?), bool? deleteSend = default(bool?), bool? deleteReceive = default(bool?), bool? deleteShare = default(bool?), bool? createNotification = default(bool?), bool? updateNotification = default(bool?), bool? deleteNotification = default(bool?), bool? createUser = default(bool?), bool? updateUser = default(bool?), bool? deleteUser = default(bool?), bool? userConnect = default(bool?), bool? userDisconnect = default(bool?))
        {
        ...
        {
            return this.Equals(input as CallbackSettingsValuesTriggers);
        }

        /// <summary>
        /// Returns true if CallbackSettingsValuesTriggers instances are equal
        /// </summary>
        /// <param name="input">Instance of CallbackSettingsValuesTriggers to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CallbackSettingsValuesTriggers input)
        {
            if (input == null)
                return false;
