...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SSHKeyCollectionResponse :  IEquatable<SSHKeyCollectionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SSHKeyCollectionResponse" /> class.
        /// </summary>
        ...
        public SSHKeyCollectionResponse(int? responseStatus = default(int?), int? totalResults = default(int?), int? returnedResults = default(int?), List<SSHKey> data = default(List<SSHKey>), List<User> included = default(List<User>))
        {
        ...
        {
            return this.Equals(input as SSHKeyCollectionResponse);
        }

        /// <summary>
        /// Returns true if SSHKeyCollectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SSHKeyCollectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SSHKeyCollectionResponse input)
        {
            if (input == null)
                return false;
