...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class WebhookActivityAttributesV1 :  IEquatable<WebhookActivityAttributesV1>, IValidatableObject
    {
        /// <summary>
        /// Event type
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="WebhookActivityAttributesV1" /> class.
        /// </summary>
        /// <param name="webhookId">Unique ID of webhook configuration.</param>
        /// <param name="webhookFormat">What version of webhook message is being sent &#x60;v1&#x60;.</param>
        ...
        public WebhookActivityAttributesV1(int? webhookId = default(int?), string webhookFormat = default(string), string attemptId = default(string), string accountId = default(string), bool? resend = default(bool?), string endpointUrl = default(string), EventEnum? _event = default(EventEnum?), int? status = default(int?), string ipAddress = default(string), string response = default(string), WebhookV1Details details = default(WebhookV1Details), string webhookPath = default(string), string resourcePath = default(string), string username = default(string), string created = default(string))
        {
        ...
        /// </summary>
        /// <value>What version of webhook message is being sent &#x60;v1&#x60;</value>
        ...
        public WebhookV1Details Details { get; set; }
        ...
        {
            return this.Equals(input as WebhookActivityAttributesV1);
        }

        /// <summary>
        /// Returns true if WebhookActivityAttributesV1 instances are equal
        /// </summary>
        /// <param name="input">Instance of WebhookActivityAttributesV1 to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(WebhookActivityAttributesV1 input)
        {
            if (input == null)
                return false;
