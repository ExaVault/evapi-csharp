...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class SSHKeyResponse :  IEquatable<SSHKeyResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SSHKeyResponse" /> class.
        /// </summary>
        /// <param name="responseStatus">Http status code of the response..</param>
        /// <param name="data">data.</param>
        /// <param name="included">included.</param>
        public SSHKeyResponse(int? responseStatus = default(int?), SSHKey data = default(SSHKey), List<User> included = default(List<User>))
        {
        ...
        {
            return this.Equals(input as SSHKeyResponse);
        }

        /// <summary>
        /// Returns true if SSHKeyResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of SSHKeyResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(SSHKeyResponse input)
        {
            if (input == null)
                return false;
