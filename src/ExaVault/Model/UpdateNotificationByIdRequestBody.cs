...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateNotificationByIdRequestBody :  IEquatable<UpdateNotificationByIdRequestBody>, IValidatableObject
    {
        /// <summary>
        ...
        public UpdateNotificationByIdRequestBody(ActionEnum? action = default(ActionEnum?), List<string> usernames = default(List<string>), bool? sendEmail = default(bool?), List<string> recipients = default(List<string>), string message = default(string))
        {
            this.Action = action;
        ...
        {
            return this.Equals(input as UpdateNotificationByIdRequestBody);
        }

        /// <summary>
        /// Returns true if UpdateNotificationByIdRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateNotificationByIdRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateNotificationByIdRequestBody input)
        {
            if (input == null)
                return false;
