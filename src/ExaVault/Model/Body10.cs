...
namespace ExaVault.Model
{
        ...
        public partial class Body10 :  IEquatable<Body10>, IValidatableObject
    {
        ...
        public Body10(List<string> resources = default(List<string>), string parentResource = default(string), string archiveName = default(string))
        {
            // to ensure "resources" is required (not null)
            if (resources == null)
            {
                throw new InvalidDataException("resources is a required property for Body10 and cannot be null");
            }
            else
            {
