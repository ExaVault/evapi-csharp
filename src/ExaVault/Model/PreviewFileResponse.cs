...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class PreviewFileResponse :  IEquatable<PreviewFileResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PreviewFileResponse" /> class.
        /// </summary>
        /// <param name="responseStatus">HTTP Status Code.</param>
        /// <param name="data">data.</param>
        public PreviewFileResponse(int? responseStatus = default(int?), PreviewFile data = default(PreviewFile))
        {
        ...
        public PreviewFile Data { get; set; }
        ...
        {
            return this.Equals(input as PreviewFileResponse);
        }
        ...
        /// <returns>Boolean</returns>
        public bool Equals(PreviewFileResponse input)
        {
            if (input == null)
                return false;
