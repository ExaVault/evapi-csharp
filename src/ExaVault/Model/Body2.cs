...
namespace ExaVault.Model
{
        ...
        public partial class Body2 :  IEquatable<Body2>, IValidatableObject
    {
        ...
        public Body2(string formDescription = default(string), string submitButtonText = default(string), string successMessage = default(string), List<FormsidElements> elements = default(List<FormsidElements>), string cssStyles = default(string))
        {
