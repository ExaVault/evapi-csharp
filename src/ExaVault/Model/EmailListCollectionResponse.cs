...
namespace ExaVault.Model
{
        ...
        public partial class EmailListCollectionResponse :  IEquatable<EmailListCollectionResponse>, IValidatableObject
    {
        ...
        public EmailListCollectionResponse(int? responseStatus = default(int?), int? totalResults = default(int?), int? returnedResults = default(int?), List<EmailList> data = default(List<EmailList>), List<User> included = default(List<User>))
        {
