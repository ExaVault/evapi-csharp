...
namespace ExaVault.Model
{
        ...
        public partial class User :  IEquatable<User>, IValidatableObject
    {
        ...
        public User(int? id = default(int?), string type = default(string), UserAttributes attributes = default(UserAttributes), UserRelationships relationships = default(UserRelationships))
        {
            this.Id = id;
            this.Type = type;
