...
namespace ExaVault.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class UpdateAccountRequestBody :  IEquatable<UpdateAccountRequestBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="UpdateAccountRequestBody" /> class.
        /// </summary>
        ...
        public UpdateAccountRequestBody(bool? quotaNoticeEnabled = default(bool?), int? quotaNoticeThreshold = default(int?), bool? secureOnly = default(bool?), bool? complexPasswords = default(bool?), bool? showReferralLinks = default(bool?), string externalDomain = default(string), string emailContent = default(string), string emailSubject = default(string), List<AccountAllowedIpRanges> allowedIpRanges = default(List<AccountAllowedIpRanges>), CallbackSettingsValues callbackSettings = default(CallbackSettingsValues), BrandingSettingsValues brandingSettings = default(BrandingSettingsValues), bool? accountOnboarding = default(bool?), string customSignature = default(string))
        {
        ...
        public CallbackSettingsValues CallbackSettings { get; set; }

        /// <summary>
        /// Gets or Sets BrandingSettings
        /// </summary>
        [DataMember(Name="brandingSettings", EmitDefaultValue=false)]
        public BrandingSettingsValues BrandingSettings { get; set; }
        ...
        {
            return this.Equals(input as UpdateAccountRequestBody);
        }

        /// <summary>
        /// Returns true if UpdateAccountRequestBody instances are equal
        /// </summary>
        /// <param name="input">Instance of UpdateAccountRequestBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(UpdateAccountRequestBody input)
        {
            if (input == null)
                return false;
