...
namespace ExaVault.Model
{
        ...
        public partial class UpdateAccountRequestBody :  IEquatable<UpdateAccountRequestBody>, IValidatableObject
    {
        ...
        public UpdateAccountRequestBody(bool? secureOnly = default(bool?), bool? complexPasswords = default(bool?), bool? showReferralLinks = default(bool?), string externalDomain = default(string), string emailContent = default(string), string emailSubject = default(string), List<AccountAllowedIpRanges> allowedIpRanges = default(List<AccountAllowedIpRanges>), BrandingSettingsValues brandingSettings = default(BrandingSettingsValues), bool? accountOnboarding = default(bool?), string customSignature = default(string), AccountQuotaValues quota = default(AccountQuotaValues))
        {
        ...
        public AccountQuotaValues Quota { get; set; }
